    ...
    <section id="projects" className="py-32 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <span className="text-sm tracking-wider text-white/50 uppercase font-medium block mb-4">
            Portfolio
          </span>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {projects.map((project, index) => (
            ...
            >
              <div className="border border-white/10 rounded bg-white/5 backdrop-blur-sm hover:bg-white/10 hover:border-white/20 transition-all duration-500 overflow-hidden">
                <div className="p-8">
                  {/* Header */}
                  <div className="mb-6">
                    <div className="text-sm text-white/50 font-light tracking-wide mb-2">
                      {project.subtitle}
                    </div>
                  ...
                  {/* Impact */}
                  <div className="mb-6">
                    <div className="text-sm text-white/50 italic border-l-2 border-white/20 pl-4">
                      {project.impact}
                    </div>
                  </div>
                  ...
                  <div className="mb-8">
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech, techIndex) => (
                        <span
                          key={techIndex}
                          className="text-xs text-white/60 border border-white/20 rounded px-2 py-1 font-light"
                        >
                          {tech}
                        </span>
                      ))}
                  ...
                  <div className="flex gap-4">
                    {project.liveUrl && (
                      <a
                        ...
                        className="inline-flex items-center text-sm text-white/80 hover:text-white transition-colors group-hover:translate-x-1 transform transition-transform duration-200"
                      >
                        View Live
                    ...
                    {project.githubUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center text-sm text-white/60 hover:text-white/80 transition-colors"
                      >
                        Source Code
                        <span className="ml-2">→</span>
                      </a>
